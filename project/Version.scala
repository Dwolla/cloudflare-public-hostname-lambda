 ...
 * https://raw.githubusercontent.com/typelevel/sbt-typelevel/main/kernel/src/main/scala/org/typelevel/sbt/kernel/V.scala
 */
...
object Version {
  val version: Regex = """^(0|[1-9]\d*)\.(0|[1-9]\d*)(?:\.(0|[1-9]\d*))?(?:-(.+))?$""".r
